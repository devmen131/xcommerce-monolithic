...
INSERT INTO public."user" (id, active, address, email_address, first_name, last_name, password, username)
VALUES (1, true, '', 'alice@xcommerce.com', 'Alice', 'Alice', '$2a$10$dw7XTEYaHPYd0kdptthyzejb5Uiher9VX9OSM9jrIX01Ln/.6RgVW', 'alice');
INSERT INTO public.authority (id, active, authority, username)
VALUES (2, true, 'ROLE_USER', 'alice');
